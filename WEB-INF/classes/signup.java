...
public class signup extends HttpServlet {
    ...
    try
    {
      ...
      {    
       String query = "INSERT INTO data(firstname,lastname,username,age,email,degree,password,status)VALUES('"+ firstname + "','" + lastname + "','" + username + "','" + age + "','" + email + "','"+ degree + "','" +    password+ "','" + status+ "') ";
