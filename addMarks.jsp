...
<html lang="en">
  ...
  <body id="img1" style="color: whitesmoke;">  
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 offset-md-3" style="font-size: medium;">
          <form name="marks_form" method="post" action="saveMarks"  class="mt-2 p-4 bg-dark shadow" onsubmit="return validation_marks()" >
             <h2 class="mb-5 text-center">ADD Marks</h2>
                
                <div> 
                  <label class="display-6"  >Select Course</label> 
